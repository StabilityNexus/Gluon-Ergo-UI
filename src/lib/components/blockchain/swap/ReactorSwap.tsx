...
export function ReactorSwap() {
            ...
            <div className="flex min-w-0 flex-1 items-center justify-center pl-8 sm:justify-end">
              ...
              >
                <NumericFormat
                  ...
                  className={cn(
                    "w-full min-w-[80px] border-0 bg-transparent text-left text-4xl font-bold focus:outline-none focus-visible:ring-0 sm:text-right",
  ...
  const renderGauGaucCard = (isFromCard?: boolean) => {
    ...
    return (
      <motion.div
        className="w-full flex-1 space-y-4 py-6"
      ...
      >
        <motion.div
          className="grid grid-cols-1 justify-between gap-8 px-8 sm:grid-cols-2"
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.1, duration: 0.2 }}
        >
