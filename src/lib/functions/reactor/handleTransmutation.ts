...
export const calculateTransmutationAmounts = async (
    { gluonInstance, gluonBox, oracleBox, nodeService, value, fromTokenSymbol }: TransmutationParams
    ...
    try {
        ...
        try {
            if (fromTokenSymbol === "GAUC") {
                willGet = BigInt(await gluonInstance.transmuteToGoldWillGet(
                    gluonBox,
                    oracleBox,
                    Number(inputAmount),
                    height
                ...
                willGet = BigInt(await gluonInstance.transmuteFromGoldWillGet(
                    gluonBox,
                    oracleBox,
                    Number(inputAmount),
                    height
...
export const handleTransmuteToGoldSwap = async (
    { gluonInstance, gluonBoxJs, oracleBoxJs, userBoxes, nodeService, ergoWallet, amount }: {
        gluonInstance: any,
        gluonBoxJs: any,
        oracleBoxJs: any,
        userBoxes: any[],
